...
# Load
file <- "C:\\Users\\dladcock\\OneDrive - Syracuse University\\Thesis\\Call Repertoire\\geobath\\GEBCO_09_May_2025_b378a4ce03e3\\gebco_2024_n41.11_s39.83_w-73.15_e-70.74.tif"
r <- raster(file)
...
## Seconds to Date  - Calls
#bp23_205c
```{r}
# Step 1: Load necessary libraries
library(dplyr)

# Step 2: Define the starting time
start_time <- as.POSIXct("2023-07-24 13:02:53")

# Step 3: Read the TXT file (update the file path accordingly)
data <- read.delim("G:\\AS-Filer\\BIO\\sparks\\Students\\General\\DanaA\\1_Finwhale_SENE\\Data\\Analysis\\Selection tables\\Focal\\bp23_205c_selections_focal.txt", header = TRUE)

# Step 4: Check the structure of the data
str(data)

# Step 5: Ensure the seconds_elapsed column is numeric
data$seconds_elapsed <- as.numeric(data$Begin.Time..s.)

# Step 6: Create a new column for Time of Day
data <- data %>%
  mutate(Time_of_Day = start_time + seconds_elapsed)

# Step 7: Format Time_of_Day to show only time (hour, minute, and second)
data$Time_Only <- format(data$Time_of_Day, "%H:%M:%S")

# Step 8: Write the updated data frame to a new text file
output_file <- "G:\\AS-Filer\\BIO\\sparks\\Students\\General\\DanaA\\1_Finwhale_SENE\\Data\\Analysis\\Selection tables\\Focal\\bp23_205c_selections_datetime.txt"
write.table(data, file = output_file, row.names = FALSE, sep = "\t", quote = FALSE)
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2023-07-24 16:12:50")

# Step 3: Read the TXT file (update the file path accordingly)
data <- read.delim("G:\\AS-Filer\\BIO\\sparks\\Students\\General\\DanaA\\1_Finwhale_SENE\\Data\\Analysis\\Selection tables\\Focal\\bp23_205d_selections_focal.txt", header = TRUE)
...
# Step 8: Write the updated data frame to a new text file
output_file <- "G:\\AS-Filer\\BIO\\sparks\\Students\\General\\DanaA\\1_Finwhale_SENE\\Data\\Analysis\\Selection tables\\Focal\\bp23_205d_selections_datetime.txt"
write.table(data, file = output_file, row.names = FALSE, sep = "\t", quote = FALSE)
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2023-07-25 15:59:09")

# Step 3: Read the TXT file
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2023-07-31 10:35:45")
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2023-08-01 18:49:17")
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2024-07-22 17:35:18")
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2024-07-23 16:06:24")
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2024-07-25 09:40:06")
...
# Step 2: Define the starting time
start_time <- as.POSIXct("2024-07-27 14:07:34")
